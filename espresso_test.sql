...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 21, 2016 at 02:52 AM
...
--
-- Database: `espresso_test`
--
CREATE DATABASE IF NOT EXISTS `espresso_test` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `espresso_test`;
...
INSERT INTO `procedures` (`id`, `name`, `description`) VALUES
(1, 'SSOP', NULL),
(2, 'GMP', NULL);
...
--
-- Dumping data for table `recovering_passwords`
--

INSERT INTO `recovering_passwords` (`id`, `user_id`, `expiration_date`, `token`) VALUES
(3, 1, '2016-09-21 00:00:00', '8b3c7e0f4c5207ac5ee4666ce7e8d0cd7b6a84537f66b09fdbf0ae1a505d662f');
...
--
-- Dumping data for table `user_procedure_privileges`
--

INSERT INTO `user_procedure_privileges` (`id`, `user_id`, `zone_id`, `procedure_id`, `privilege_id`) VALUES
(1, 1, 1, 1, 3),
(2, 2, 2, 2, 3);
...
INSERT INTO `user_profiles` (`id`, `employee_num`, `first_name`, `last_name`, `email`, `account_nickname`, `login_password`) VALUES
(1, 1110027, 'Carlos Alberto', 'Oliva Moreno', 'caom92@live.com', 'coliva', '7b85175b455060e3237e925f023053ca9515e8682a83c8b09911c724a1f8b75f'),
(2, 327942, 'Víctor', 'Miracle Macotela', 'victor.miracle@uabc.edu.mx', 'vmiracle', '5e884898da28047151d0e56f8dc6292773603d0d6aabbdd62a11ef721d1542d8');
