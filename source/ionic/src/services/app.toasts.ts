...
export class ToastService implements OnInit
{
  ...
  private static infoMessages = {
    es: {
      ...
      lastActionReverseNetwork: 'Hubo un error en la conexión; su última acción se revirtió',
      lastActionReverseBadRequest: 'Hubo un error en la petición al servidor; notifique al administrador',
    ...
    en: {
      ...
      lastActionReverseNetwork: 'There was a network error; your last action was reversed',
      lastActionReverseBadRequest: 'There was a request error; notify the administrator',
