...
class Checks extends db\OrderedItemsTable
{
  function __construct() { 
    parent::__construct('gap_packing_master_sanitation_checks');
  }
  ...
  function selectByZoneID($zoneID) {
    return parent::select(
      ...
      [
        '[><]gap_packing_master_sanitation_areas(a)' => ['area_id' => 'id'],
        '[><]gap_packing_master_sanitation_types(t)' => ['type_id' => 'id']
      ]
    );
  }
