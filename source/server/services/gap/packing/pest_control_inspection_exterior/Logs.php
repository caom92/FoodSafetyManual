...
class Logs extends db\InsertableTable
{
  function __construct() { 
    parent::__construct('gap_packing_pest_control_inspection_exterior_logs');
  }
  ...
  function selectByCaptureDateID($logID) {
    return parent::select(
      ...
      [
        '[><]gap_packing_pest_control_inspection_exterior_areas(a)' => [
          'area_id' => 'id'
        ]
      ]
    );
  ...
  function selectTotalCapturedPestsByDateInterval($startDate, $endDate) {
    return parent::$dataBase->query(
      ...
      FROM `gap_packing_pest_control_inspection_exterior_logs` AS `l`
      INNER JOIN `gap_packing_pest_control_inspection_exterior_areas` AS `a`
      ON `l`.`area_id` = `a`.`id`
  ...
  function selectWithNamesByCaptureDateID($logID) {
    return parent::select(
      ...
      [
        ...
        '[>]gap_packing_pest_control_inspection_exterior_protection_status(ps)' => [
          'protection_status_id' => 'id'
        ],
        '[>]gap_packing_pest_control_inspection_exterior_equipment_status(es)' => [
          'equipment_status_id' => 'id'
        ],
        '[>]gap_packing_pest_control_inspection_exterior_pest_types(pt)' => [
          'pest_type_id' => 'id'
        ],
        '[>]gap_packing_pest_control_inspection_exterior_area_verification(av)' => [
          'area_verification_id' => 'id'
        ],
        '[>]gap_packing_pest_control_inspection_exterior_tasks(t)' => [
          'task_id' => 'id'
        ],
        '[>]gap_packing_pest_control_inspection_exterior_corrective_actions(ca)' => [
