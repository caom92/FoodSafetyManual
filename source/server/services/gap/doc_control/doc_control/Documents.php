...
// Interfaz para la tabla gap_packing_doc_control_doc_control_documents
class Documents extends db\ToggableItemsTable
{
  // Crea una instancia de una interfaz a la base de datos para modificar 
  // la tabla gap_packing_doc_control_doc_control_documents
  function __construct() { 
    parent::__construct('gap_doc_control_doc_control_documents');
  }
