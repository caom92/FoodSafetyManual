...
class Logs extends db\InsertableTable
{
  function __construct() { 
    parent::__construct('gmp_packing_pest_control_inspection_interior_logs');
  }
  ...
  function selectByCaptureDateID($logID) {
    return parent::select(
      ...
      [
        '[><]gmp_packing_pest_control_inspection_interior_areas(a)' => [
          'area_id' => 'id'
        ]
      ]
    );
  ...
  function selectTotalCapturedPestsByDateInterval($startDate, $endDate) {
    return parent::$dataBase->query(
      ...
      FROM `gmp_packing_pest_control_inspection_interior_logs` AS `l`
  ...
  function selectWithNamesByCaptureDateID($logID) {
    return parent::select(
      ...
      [
        ...
        '[>]gmp_packing_pest_control_inspection_interior_protection_status(ps)' => [
          'protection_status_id' => 'id'
        ],
        '[>]gmp_packing_pest_control_inspection_interior_equipment_status(es)' => [
          'equipment_status_id' => 'id'
        ],
        '[>]gmp_packing_pest_control_inspection_interior_pest_types(pt)' => [
          'pest_type_id' => 'id'
        ],
        '[>]gmp_packing_pest_control_inspection_interior_area_verification(av)' => [
          'area_verification_id' => 'id'
        ],
        '[>]gmp_packing_pest_control_inspection_interior_tasks(t)' => [
          'task_id' => 'id'
        ],
        '[>]gmp_packing_pest_control_inspection_interior_corrective_actions(ca)' => [
