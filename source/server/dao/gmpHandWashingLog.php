...
class GMPHandWashingLog extends Table 
{
    ...
    function searchItemsByAreaIDAndDateInterval($areaID, $start, $end)
    {
        return parent::join([
            ...
            "[><]workday_periods" => [
                "gmp_hand_washing_workday_period_log.workday_period_id" => "id"
                ]
        ], [
            ...
            "AND" => [
                ...
                "gmp_hand_washing_daily_log.date[>=]" => $start,
                "gmp_hand_washing_daily_log.date[<=]" => $end
            ],
