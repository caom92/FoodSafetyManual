function addInventoryManager(controlsWrapper, contentWrapper){
    $("#log_name").html("Document Control");
...
function loadInventory(htmlElement){
    ...
    $server.request({
        service: 'inventory-gmp-doc-control-doc-control',
        success: function(response){
            ...
            changeLanguage();
            //$(htmlElement).html(JSON.stringify(response));
...
function gmpPackingHandWashingInventoryTable(htmlElement, data){
    ...
    $("#add_inventory").on("click",function(e){
        addItemToInventory("gmp-doc-control-doc-control", false);
    });

    $("input:checkbox").on("change",function(){
        var itemID = $(this).data("id");
        toggleItem("gmp-doc-control-doc-control", itemID);
    });
}
