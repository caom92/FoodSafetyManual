function customersTable(htmlElement, data){
    var tableJSON = {"type":"table","id":"sort","classes":"highlight","thead":{},"tbody":{},"tfoot":{}};

    tableJSON.thead = {"type":"thead","rows":[{"type":"tr","columns":[{"type":"th","classes":"supplier_id"},{"type":"th","classes":"supplier_company"},{"type":"th","classes":"supplier_contact"},{"type":"th","classes":"supplier_phone_number"},{"type":"th","classes":"supplier_email"},{"type":"th","classes":"customer_city"},{"type":"th","classes":"customer_salesman"},{"type":"th","contents":""}]},{"type":"tr","columns":[{"type":"td","classes":"dynamic-search","contents":{"field":{"type":"input","id":"id-search","classes":"validate id_search","fieldType":"text"}}},{"type":"td","classes":"dynamic-search","contents":{"field":{"type":"input","id":"company-search","classes":"validate company_search","fieldType":"text"}}},{"type":"td","classes":"dynamic-search","contents":{"field":{"type":"input","id":"contact-search","classes":"validate contact_search","fieldType":"text"}}},{"type":"td","classes":"dynamic-search","contents":{"field":{"type":"input","id":"phone-search","classes":"validate phone_search","fieldType":"text"}}},{"type":"td","classes":"dynamic-search","contents":{"field":{"type":"input","id":"email-search","classes":"validate email_search","fieldType":"text"}}},{"type":"td","classes":"dynamic-search","contents":{"field":{"type":"input","id":"city-search","classes":"validate city_search","fieldType":"text"}}},{"type":"td","classes":"dynamic-search","contents":{"field":{"type":"input","id":"salesman-search","classes":"validate salesman_search","fieldType":"text"}}}]}]};

    tableJSON.tfoot = {"type":"tfoot","rows":[{"type":"tr","columns":[{"type":"td","contents":""},{"type":"td","contents":{"field":{"type":"input","id":"company_add","classes":"validate add_item add-customer-element","fieldType":"text","validations":{"type":"text","max":{"value":128},"required":{"value":true}},"data":{"param":{"name":"company_name","type":"text"}}}}},{"type":"td","contents":{"field":{"type":"input","id":"contact_add","classes":"validate add_item add-customer-element","fieldType":"text","validations":{"type":"text","max":{"value":64},"required":{"value":true}},"data":{"param":{"name":"contact_name","type":"text"}}}}},{"type":"td","contents":{"field":{"type":"input","id":"phone_add","classes":"validate add_item add-customer-element","fieldType":"text","validations":{"type":"text","max":{"value":16},"required":{"value":true}},"data":{"param":{"name":"phone_num","type":"text"}}}}},{"type":"td","contents":{"field":{"type":"input","id":"email_add","classes":"validate add_item add-customer-element","fieldType":"text","validations":{"type":"text","max":{"value":64},"required":{"value":true}},"data":{"param":{"name":"email","type":"text"}}}}},{"type":"td","contents":{"field":{"type":"input","id":"city_add","classes":"validate add_item add-customer-element","fieldType":"text","validations":{"type":"text","max":{"value":64},"required":{"value":true}},"data":{"param":{"name":"city","type":"text"}}}}},{"type":"td","contents":{"field":{"type":"input","id":"salesman_add","classes":"validate add_item add-customer-element","fieldType":"text","validations":{"type":"text","max":{"value":64},"required":{"value":true}},"data":{"param":{"name":"salesman","type":"text"}}}}},{"type":"td","contents":{"field":{"type":"floating","id":"add_inventory","classes":"btn-floating waveseffect waves-light green center","icon":{"type":"icon","icon":"mdi-plus","size":"mdi-24px"}}}}]}]};

    tableJSON.tbody = {"type":"tbody","rows":[]};

    for(var item of data){
        tableJSON.tbody.rows.push(customersRow(item));
    }
...
function customersRow(item){
    ...
    inventoryRow.columns.push({"type":"td","contents":item.city,"classes":"city-column search-column"});
    inventoryRow.columns.push({"type":"td","contents":item.salesman,"classes":"salesman-column search-column"});
...
function validateCustomer(){
    ...
    $('.add-customer-element').each(function(){
        if(!$(this).validate()){
            returnValue = false;
        }
    });
...
$(function(){
    $server.request({
        ...
        success: function(response, message, xhr) {
            ...
            customersTable("#content_wrapper", response.data);
            ...
            dynamicSearchBind("city-search", "city-column");
            dynamicSearchBind("salesman-search", "salesman-column");
            changeLanguage();
        }
    });
});