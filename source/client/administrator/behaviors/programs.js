...
function programRow(program){
    ...
    inventoryRow.columns.push({"type":"td","contents":program.id,"classes":"id-column"});
    inventoryRow.columns.push({"type":"td","contents":program.log_name,"classes":"program-column"});
    inventoryRow.columns.push({"type":"td","contents":program.pdf_footer,"classes":"pdf-column"});
    inventoryRow.columns.push({"type":"td","contents":program.html_footer,"classes":"html-column"});
...
function programEditableRow(program){
    ...
    inventoryRow.columns.push({"type":"td","contents":program.id,"classes":"id-column"});
    inventoryRow.columns.push({"type":"td","contents":program.log_name,"classes":"program-column"});
    inventoryRow.columns.push({"type":"td","contents":{"field":{"type":"input","id":"name_add","classes":"validate","value":program.pdf_footer,"fieldType":"text"}},"classes":"pdf-column"});
    inventoryRow.columns.push({"type":"td","contents":{"field":{"type":"input","id":"name_add","classes":"validate","value":program.html_footer,"fieldType":"text"}},"classes":"html-column"});
...
function bindSaveButtonFunctionality(){
    $("a[id^='save_']").on("click", function(){
        console.log("Presionado");
        console.log($(this).data());
        $("#edit_program_" + $(this).data("id")).after(tableRow(programRow($(this).data("item"))));
        $("#edit_program_" + $(this).data("id")).remove();
...
$(function (){
    ...
    $.getScript( "source/client/common/scripts/logs/form-creator.js", function( data, textStatus, jqxhr ) {
        $.getScript( "source/client/common/scripts/logs/table-creator.js", function( data, textStatus, jqxhr ) {
            programTable("#programs_wrapper", null);
            bindEditButtonFunctionality();
        });
    });
    changeLanguage();
