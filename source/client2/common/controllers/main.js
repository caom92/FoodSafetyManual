...
angular
  .module('ManualApp', ['ngRoute'])
  .constant('site', SiteDirectory)
  .service('server', ServerService)
  //.controller('Main', MainController)
  .config(function($routeProvider, site) {
    // $routeProvider
    //   .when('/', {
    //     templateUrl: site.common.layouts + 'login.html',
    //     controller: 'LogIn'
    //   })
    //   .when('/password-recovery', {
    //     templateUrl: site.common.layouts + 'pasword-recovery.html',
    //     controller: 'PasswordRecovery'
    //   })
    //   .when('/edit-profile', {
    //     templateUrl: site.common.layouts + 'edit-profile.html',
    //     controller: 'EditProfile'
    //   })
    //   .when('/report-problem', {
    //     templateUrl: site.common.layouts + 'report-problem',
    //     controller: 'ReportProblem'
    //   })
  })
  .run(authenticateAccount)
