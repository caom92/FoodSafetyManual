...
@Component({
  selector: 'gap-packing-pest-control-inspection-flytrap-report',
  templateUrl: './gap-packing-pest-control-inspection-flytrap-report.component.html'
})

export class GAPPackingPestControlInspectionFlytrapReportComponent extends SuperReportComponent {
  @Input() report: Report
