...
@Component({
  selector: 'gmp-packing-pest-control-inspection-flytrap-report',
  templateUrl: './gmp-packing-pest-control-inspection-flytrap-report.component.html'
})

export class GMPPackingPestControlInspectionFlytrapReportComponent extends SuperReportComponent {
  @Input() report: Report
