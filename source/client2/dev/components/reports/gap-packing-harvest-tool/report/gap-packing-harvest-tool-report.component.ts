...
import { Report } from '../interfaces/gap-packing-harvest-tool-report.interface'

@Component({
  selector: 'gap-packing-harvest-tool-report',
  templateUrl: './gap-packing-harvest-tool-report.component.html'
})

export class GAPPackingHarvestToolReportComponent extends SuperReportComponent {
  @Input() report: Report
