...
@Component({
  selector: 'gap-packing-pest-control-inspection-interior-report',
  templateUrl: './gap-packing-pest-control-inspection-interior-report.component.html'
})

export class GAPPackingPestControlInspectionInteriorReportComponent extends SuperReportComponent {
  @Input() report: Report
