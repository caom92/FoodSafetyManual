...
export class GMPDocControlDocControlReportComponent extends SuperReportComponent {
  ...
  public getCSS(appendCSS?: string): string {
    return '<style>' + this.commonCSS() + ((appendCSS === String(appendCSS)) ? appendCSS : '') + '.even{background-color:#b8e0b9}.verticaltext{writing-mode:tb-rl;transform:rotate(90deg);white-space:nowrap;word-break:break-word;bottom:0}.typeTitle{background-color:yellow;width:501px}.fullColumn{background-color:#D3D3D3;width:631px}.nameColumn{width:116px}.numberColumn{width:30px}.timeColumn{width:40px}.areaColumn{width:90px}.statusColumn{width:85px}.actionColumn{width:70px}.commentColumn{width:200px}.report_image{width:350px!important;padding-left:140px}</style>'
  }
}