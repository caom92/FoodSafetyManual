...
@Component({
  selector: 'gmp-packing-product-revision-report',
  templateUrl: './gmp-packing-product-revision-report.component.html'
})

export class GMPPackingProductRevisionReportComponent extends SuperReportComponent {
  @Input() report: Report
