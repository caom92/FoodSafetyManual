...
@Component({
  selector: 'gmp-packing-pest-control-inspection-exterior-report',
  templateUrl: './gmp-packing-pest-control-inspection-exterior-report.component.html'
})

export class GMPPackingPestControlInspectionExteriorReportComponent extends SuperReportComponent {
  @Input() report: Report
