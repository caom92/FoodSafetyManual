...
import { ReportRequest } from '../../../reports/reports.interface'
...
export class RegisterReportGeneratorComponent {
  ...
  public requestPDFReport(): void {
    ...
    setTimeout(() => {
      this.pdfForm.nativeElement.submit()
    }, 100)
  }
  ...
  public getCSS(): string {
    ...
    return base + tableWidth + signatures + this.css
  }
}