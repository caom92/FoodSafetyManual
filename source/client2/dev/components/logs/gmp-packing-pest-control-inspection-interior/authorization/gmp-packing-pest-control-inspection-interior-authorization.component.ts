...
import { Authorization, AuthorizationArea } from '../interfaces/gmp-packing-pest-control-inspection-interior-authorization.interface'
import { maxLengths } from '../max-lengths/max-lengths'

@Component({
  selector: 'gmp-packing-pest-control-inspection-interior-authorization',
  templateUrl: './gmp-packing-pest-control-inspection-interior-authorization.component.html'
})

export class GMPPackingPestControlInspectionInteriorAuthorizationComponent extends SuperAuthorizationComponent {
