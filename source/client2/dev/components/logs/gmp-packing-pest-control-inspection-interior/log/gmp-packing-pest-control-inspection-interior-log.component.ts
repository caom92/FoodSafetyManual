...
import { Log, LogArea } from '../interfaces/gmp-packing-pest-control-inspection-interior-log.interface'
import { maxLengths } from '../max-lengths/max-lengths'

@Component({
  selector: 'gmp-packing-pest-control-inspection-interior-log',
  templateUrl: './gmp-packing-pest-control-inspection-interior-log.component.html'
})

export class GMPPackingPestControlInspectionInteriorLogComponent extends SuperUpdateComponent {
  @Input() log: Log = null
