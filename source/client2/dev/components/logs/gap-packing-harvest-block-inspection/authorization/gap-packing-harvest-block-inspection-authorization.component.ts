...
export class GAPPackingHarvestBlockInspectionAuthorizationComponent extends SuperAuthorizationComponent {
  ...
  initForm(): void {
    ...
    this.captureForm.addControl('units', new FormControl(this.dataResolver.resolveNumber(this.log.units), [Validators.required]))
    this.captureForm.addControl('unit_type', new FormControl(this.dataResolver.resolveNumber(this.log.unit_type), [Validators.required]))
