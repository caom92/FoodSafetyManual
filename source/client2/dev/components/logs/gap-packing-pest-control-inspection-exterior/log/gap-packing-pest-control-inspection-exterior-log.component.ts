...
import { Log, LogArea } from '../interfaces/gap-packing-pest-control-inspection-exterior-log.interface'
import { maxLengths } from '../max-lengths/max-lengths'

@Component({
  selector: 'gap-packing-pest-control-inspection-exterior-log',
  templateUrl: './gap-packing-pest-control-inspection-exterior-log.component.html'
})

export class GAPPackingPestControlInspectionExteriorLogComponent extends SuperUpdateComponent {
  @Input() log: Log = null
