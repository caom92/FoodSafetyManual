...
import { Authorization, AuthorizationArea } from '../interfaces/gap-packing-pest-control-inspection-exterior-authorization.interface'
import { maxLengths } from '../max-lengths/max-lengths'

@Component({
  selector: 'gap-packing-pest-control-inspection-exterior-authorization',
  templateUrl: './gap-packing-pest-control-inspection-exterior-authorization.component.html'
})

export class GAPPackingPestControlInspectionExteriorAuthorizationComponent extends SuperAuthorizationComponent {
