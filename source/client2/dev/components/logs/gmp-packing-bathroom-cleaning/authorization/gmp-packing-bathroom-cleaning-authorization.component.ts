...
import { Authorization } from '../interfaces/gmp-packing-bathroom-cleaning-authorization.interface'
import { LogDay, LogItem } from '../interfaces/gmp-packing-bathroom-cleaning-log.interface'
import { maxLengths } from '../max-lengths/max-lengths'

@Component({
  selector: 'gmp-packing-bathroom-cleaning-authorization',
  templateUrl: './gmp-packing-bathroom-cleaning-authorization.component.html'
})

export class GMPPackingBathroomCleaningAuthorizationComponent extends SuperAuthorizationComponent {
