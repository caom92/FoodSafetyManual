...
import { Log, LogArea, LogItem } from '../interfaces/gap-packing-cooler-cleaning-log.interface'

@Component({
  selector: 'gap-packing-cooler-cleaning-log',
  templateUrl: './gap-packing-cooler-cleaning-log.component.html'
})

export class GAPPackingCoolerCleaningLogComponent extends SuperUpdateComponent {
  @Input() log: Log = null
