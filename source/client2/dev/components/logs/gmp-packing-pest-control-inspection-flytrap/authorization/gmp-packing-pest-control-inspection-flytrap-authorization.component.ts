...
import { Authorization, AuthorizationArea } from '../interfaces/gmp-packing-pest-control-inspection-flytrap-authorization.interface'
import { maxLengths } from '../max-lengths/max-lengths'

@Component({
  selector: 'gmp-packing-pest-control-inspection-flytrap-authorization',
  templateUrl: './gmp-packing-pest-control-inspection-flytrap-authorization.component.html'
})

export class GMPPackingPestControlInspectionFlytrapAuthorizationComponent extends SuperAuthorizationComponent {
