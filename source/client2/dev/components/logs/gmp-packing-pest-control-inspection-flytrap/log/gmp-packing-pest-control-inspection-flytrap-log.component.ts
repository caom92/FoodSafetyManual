...
import { Log, LogArea } from '../interfaces/gmp-packing-pest-control-inspection-flytrap-log.interface'
import { maxLengths } from '../max-lengths/max-lengths'

@Component({
  selector: 'gmp-packing-pest-control-inspection-flytrap-log',
  templateUrl: './gmp-packing-pest-control-inspection-flytrap-log.component.html'
})

export class GMPPackingPestControlInspectionFlytrapLogComponent extends SuperUpdateComponent {
  @Input() log: Log = null
