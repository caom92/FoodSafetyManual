...
import { Authorization, AuthorizationArea } from '../interfaces/gap-packing-pest-control-inspection-interior-authorization.interface'
import { maxLengths } from '../max-lengths/max-lengths'

@Component({
  selector: 'gap-packing-pest-control-inspection-interior-authorization',
  templateUrl: './gap-packing-pest-control-inspection-interior-authorization.component.html'
})

export class GAPPackingPestControlInspectionInteriorAuthorizationComponent extends SuperAuthorizationComponent {
