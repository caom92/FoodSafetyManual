...
import { Log, LogArea } from '../interfaces/gap-packing-pest-control-inspection-interior-log.interface'
import { maxLengths } from '../max-lengths/max-lengths'

@Component({
  selector: 'gap-packing-pest-control-inspection-interior-log',
  templateUrl: './gap-packing-pest-control-inspection-interior-log.component.html'
})

export class GAPPackingPestControlInspectionInteriorLogComponent extends SuperUpdateComponent {
  @Input() log: Log = null
