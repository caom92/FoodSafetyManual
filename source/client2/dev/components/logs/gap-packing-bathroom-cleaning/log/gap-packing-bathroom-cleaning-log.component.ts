...
import { Log, LogDay, LogItem } from '../interfaces/gap-packing-bathroom-cleaning-log.interface'
import { maxLengths } from '../max-lengths/max-lengths'

@Component({
  selector: 'gap-packing-bathroom-cleaning-log',
  templateUrl: './gap-packing-bathroom-cleaning-log.component.html'
})

export class GAPPackingBathroomCleaningLogComponent extends SuperUpdateComponent {
  @Input() log: Log = null
