...
import { Log } from '../interfaces/gmp-packing-product-revision-log.interface'

@Component({
  selector: 'gmp-packing-product-revision-log',
  templateUrl: './gmp-packing-product-revision-log.component.html'
})

export class GMPPackingProductRevisionLogComponent extends SuperLogComponent implements OnInit {
  ...
  public initEmptyEntry(): FormGroup {
    return this._fb.group({
      ...
      production_area: ['', [Validators.required, Validators.maxLength(255)]],
      supplier: ['', [Validators.required, Validators.maxLength(255)]],
      product: ['', [Validators.required, Validators.maxLength(255)]],
      customer: ['', [Validators.required, Validators.maxLength(255)]],
