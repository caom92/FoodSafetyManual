...
import { Authorization, AuthorizationArea } from '../interfaces/gap-packing-pest-control-inspection-flytrap-authorization.interface'
import { maxLengths } from '../max-lengths/max-lengths'

@Component({
  selector: 'gap-packing-pest-control-inspection-flytrap-authorization',
  templateUrl: './gap-packing-pest-control-inspection-flytrap-authorization.component.html'
})

export class GAPPackingPestControlInspectionFlytrapAuthorizationComponent extends SuperAuthorizationComponent {
