...
import { Log, LogArea } from '../interfaces/gap-packing-pest-control-inspection-flytrap-log.interface'
import { maxLengths } from '../max-lengths/max-lengths'

@Component({
  selector: 'gap-packing-pest-control-inspection-flytrap-log',
  templateUrl: './gap-packing-pest-control-inspection-flytrap-log.component.html'
})

export class GAPPackingPestControlInspectionFlytrapLogComponent extends SuperUpdateComponent {
  @Input() log: Log = null
