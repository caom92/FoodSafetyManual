...
@Component({
  selector: '[gmp-packing-harvest-tool-add-item]',
  templateUrl: './gmp-packing-harvest-tool-add-item.component.html'
})

export class GMPPackingHarvestToolAddItemComponent extends SuperInventoryAddItemComponent implements OnInit {
