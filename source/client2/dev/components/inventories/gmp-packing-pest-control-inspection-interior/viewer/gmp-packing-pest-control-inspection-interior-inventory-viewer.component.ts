...
@Component({
  selector: 'gmp-packing-pest-control-inspection-interior-inventory-viewer',
  templateUrl: './gmp-packing-pest-control-inspection-interior-inventory-viewer.component.html',
  styleUrls: ['./custom-collection.css']
})

export class GMPPackingPestControlInspectionInteriorInventoryViewerComponent extends SuperInventoryViewer {
