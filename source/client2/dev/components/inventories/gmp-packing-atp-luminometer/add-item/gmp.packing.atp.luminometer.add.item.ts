...
@Component({
  selector: '[gmp-packing-atp-luminometer-add-item]',
  templateUrl: './gmp.packing.atp.luminometer.add.item.html'
})

export class GMPPackingATPLuminometerAddItemComponent extends SuperInventoryAddItemComponent implements OnInit {
