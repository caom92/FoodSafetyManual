...
@Component({
  selector: 'gmp-packing-pest-control-inspection-exterior-inventory-viewer',
  templateUrl: './gmp-packing-pest-control-inspection-exterior-inventory-viewer.component.html',
  styleUrls: ['./custom-collection.css']
})

export class GMPPackingPestControlInspectionExteriorInventoryViewerComponent extends SuperInventoryViewer {
