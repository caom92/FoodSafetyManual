...
@Component({
  selector: 'gmp-packing-pest-control-inspection-exterior-corrective-action-inventory',
  templateUrl: './gmp-packing-pest-control-inspection-exterior-corrective-action-inventory.component.html'
})

export class GMPPackingPestControlInspectionExteriorCorrectiveActionInventoryComponent extends SuperInventoryComponent {
  @Language() lang: string
  @Input() inventory: Array<InventoryCorrectiveAction> = []

  constructor(events: PubSubService,
    inventoryService: GMPPackingPestControlInspectionExteriorCorrectiveActionInventoryService,
