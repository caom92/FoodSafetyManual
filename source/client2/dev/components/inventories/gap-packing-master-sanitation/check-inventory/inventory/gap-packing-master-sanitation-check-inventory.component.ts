...
import { InventoryType } from '../interfaces/gap-packing-master-sanitation-check-inventory.interface'
import { AreaInventoryService } from '../../../../../services/area-inventory.service'

@Component({
  selector: 'gap-packing-master-sanitation-check-inventory',
  templateUrl: './gap-packing-master-sanitation-check-inventory.component.html'
})

export class GAPPackingMasterSanitationCheckInventoryComponent extends SuperInventoryByAreaComponent {
  @Language() lang: string
  @Input() inventory: Array<InventoryType> = []
  public type_array: Array<{ id: number, name: string }> = []

  constructor(events: PubSubService,
    inventoryService: GAPPackingMasterSanitationCheckInventoryService,
