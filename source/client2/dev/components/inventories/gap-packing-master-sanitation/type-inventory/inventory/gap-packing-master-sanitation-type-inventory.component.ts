...
@Component({
  selector: 'gap-packing-master-sanitation-type-inventory',
  templateUrl: './gap-packing-master-sanitation-type-inventory.component.html'
})

export class GAPPackingMasterSanitationTypeInventoryComponent extends SuperInventoryComponent {
  @Language() lang: string
  @Input() inventory: Array<InventoryType> = []

  constructor(events: PubSubService,
    inventoryService: GAPPackingMasterSanitationTypeInventoryService,
