...
@Component({
  selector: '[gap-packing-master-sanitation-type-inventory-add-item]',
  templateUrl: './gap-packing-master-sanitation-type-inventory-add-item.component.html'
})

export class GAPPackingMasterSanitationTypeInventoryAddItemComponent extends SuperInventoryAddItemComponent implements OnInit {
  @Language() lang: string
  newItem: FormGroup = new FormBuilder().group({})

  constructor(_fb: FormBuilder, inventoryService: GAPPackingMasterSanitationTypeInventoryService, events: PubSubService, toastService: ToastsService, formUtilService: FormUtilService) {
