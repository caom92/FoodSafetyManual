...
@Component({
  selector: 'gap-packing-master-sanitation-inventory-viewer',
  templateUrl: './gap-packing-master-sanitation-inventory-viewer.component.html',
  styleUrls: ['./custom-collection.css']
})

export class GAPPackingMasterSanitationInventoryViewerComponent extends SuperInventoryViewer {
