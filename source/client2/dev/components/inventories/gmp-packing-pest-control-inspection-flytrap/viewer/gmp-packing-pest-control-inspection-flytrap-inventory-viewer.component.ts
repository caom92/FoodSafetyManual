...
@Component({
  selector: 'gmp-packing-pest-control-inspection-flytrap-inventory-viewer',
  templateUrl: './gmp-packing-pest-control-inspection-flytrap-inventory-viewer.component.html',
  styleUrls: ['./custom-collection.css']
})

export class GMPPackingPestControlInspectionFlytrapInventoryViewerComponent extends SuperInventoryViewer {
