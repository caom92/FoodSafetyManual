...
@Component({
  selector: 'gmp-packing-pest-control-inspection-flytrap-equipment-status-inventory',
  templateUrl: './gmp-packing-pest-control-inspection-flytrap-equipment-status-inventory.component.html'
})

export class GMPPackingPestControlInspectionFlytrapEquipmentStatusInventoryComponent extends SuperInventoryComponent {
  @Language() lang: string
  @Input() inventory: Array<InventoryEquipmentStatus> = []

  constructor(events: PubSubService,
    inventoryService: GMPPackingPestControlInspectionFlytrapEquipmentStatusInventoryService,
