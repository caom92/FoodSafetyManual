...
@Component({
  selector: 'gmp-packing-pest-control-inspection-flytrap-task-inventory',
  templateUrl: './gmp-packing-pest-control-inspection-flytrap-task-inventory.component.html'
})

export class GMPPackingPestControlInspectionFlytrapTaskInventoryComponent extends SuperInventoryComponent {
  @Language() lang: string
  @Input() inventory: Array<InventoryTask> = []

  constructor(events: PubSubService,
    inventoryService: GMPPackingPestControlInspectionFlytrapTaskInventoryService,
