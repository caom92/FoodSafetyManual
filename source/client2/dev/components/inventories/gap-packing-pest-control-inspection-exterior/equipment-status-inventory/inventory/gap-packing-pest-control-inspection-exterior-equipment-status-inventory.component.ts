...
@Component({
  selector: 'gap-packing-pest-control-inspection-exterior-equipment-status-inventory',
  templateUrl: './gap-packing-pest-control-inspection-exterior-equipment-status-inventory.component.html'
})

export class GAPPackingPestControlInspectionExteriorEquipmentStatusInventoryComponent extends SuperInventoryComponent {
  @Language() lang: string
  @Input() inventory: Array<InventoryEquipmentStatus> = []

  constructor(events: PubSubService,
    inventoryService: GAPPackingPestControlInspectionExteriorEquipmentStatusInventoryService,
