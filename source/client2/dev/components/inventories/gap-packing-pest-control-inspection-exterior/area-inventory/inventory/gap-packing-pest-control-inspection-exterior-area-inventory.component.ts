...
@Component({
  selector: 'gap-packing-pest-control-inspection-exterior-area-inventory',
  templateUrl: './gap-packing-pest-control-inspection-exterior-area-inventory.component.html'
})

export class GAPPackingPestControlInspectionExteriorAreaInventoryComponent extends SuperInventoryComponent {
  @Language() lang: string
  @Input() inventory: Array<InventoryArea> = []

  constructor(events: PubSubService,
    inventoryService: GAPPackingPestControlInspectionExteriorAreaInventoryService,
