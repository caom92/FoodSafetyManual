...
@Component({
  selector: '[gap-packing-bathroom-cleaning-add-item]',
  templateUrl: './gap-packing-bathroom-cleaning-add-item.component.html'
})

export class GAPPackingBathroomCleaningAddItemComponent extends SuperInventoryAddItemComponent implements OnInit {
