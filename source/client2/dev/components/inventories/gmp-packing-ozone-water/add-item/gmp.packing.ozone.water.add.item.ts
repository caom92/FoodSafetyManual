...
@Component({
  selector: '[gmp-packing-ozone-water-add-item]',
  templateUrl: './gmp.packing.ozone.water.add.item.html'
})

export class GMPPackingOzoneWaterAddItemComponent extends SuperInventoryAddItemComponent implements OnInit {
