...
@Component({
  selector: '[gap-doc-control-doc-control-add-item]',
  templateUrl: './gap.doc.control.doc.control.add.item.html'
})

export class GAPDocControlDocControlAddItemComponent extends SuperInventoryAddItemComponent implements OnInit {
