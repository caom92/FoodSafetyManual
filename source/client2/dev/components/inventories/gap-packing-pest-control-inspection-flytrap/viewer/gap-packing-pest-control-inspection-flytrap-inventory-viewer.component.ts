...
@Component({
  selector: 'gap-packing-pest-control-inspection-flytrap-inventory-viewer',
  templateUrl: './gap-packing-pest-control-inspection-flytrap-inventory-viewer.component.html',
  styleUrls: ['./custom-collection.css']
})

export class GAPPackingPestControlInspectionFlytrapInventoryViewerComponent extends SuperInventoryViewer {
