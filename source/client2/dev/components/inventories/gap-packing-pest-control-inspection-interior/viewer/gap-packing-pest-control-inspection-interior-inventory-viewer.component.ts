...
@Component({
  selector: 'gap-packing-pest-control-inspection-interior-inventory-viewer',
  templateUrl: './gap-packing-pest-control-inspection-interior-inventory-viewer.component.html',
  styleUrls: ['./custom-collection.css']
})

export class GAPPackingPestControlInspectionInteriorInventoryViewerComponent extends SuperInventoryViewer {
