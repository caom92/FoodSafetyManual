...
@Component({
  selector: 'gap-packing-pest-control-inspection-interior-task-inventory',
  templateUrl: './gap-packing-pest-control-inspection-interior-task-inventory.component.html'
})

export class GAPPackingPestControlInspectionInteriorTaskInventoryComponent extends SuperInventoryComponent {
  @Language() lang: string
  @Input() inventory: Array<InventoryTask> = []

  constructor(events: PubSubService,
    inventoryService: GAPPackingPestControlInspectionInteriorTaskInventoryService,
