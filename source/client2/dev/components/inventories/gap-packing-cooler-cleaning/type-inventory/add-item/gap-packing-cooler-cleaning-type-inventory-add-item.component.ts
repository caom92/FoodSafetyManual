...
@Component({
  selector: '[gap-packing-cooler-cleaning-type-inventory-add-item]',
  templateUrl: './gap-packing-cooler-cleaning-type-inventory-add-item.component.html'
})

export class GAPPackingCoolerCleaningTypeInventoryAddItemComponent extends SuperInventoryAddItemComponent implements OnInit {
  @Language() lang: string
  newItem: FormGroup = new FormBuilder().group({})

  constructor(_fb: FormBuilder, inventoryService: GAPPackingCoolerCleaningTypeInventoryService, events: PubSubService, toastService: ToastsService, formUtilService: FormUtilService) {
